...
export default async function HealthFacultyPage({ params }: Props) {
    ...
    return (
        <main className="bg-gray-50 pb-20">
            <HeroSection
                ...
                backgroundImage={faculty.heroImage || "/images/hero-health.jpg"}
            />
            ...
            <DeanMessage
                ...
                image={faculty.dean?.image || faculty.deanImage || "/images/pimpinan/dekan1.png"}
            />
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-4">
                        <div className="space-y-2">
                            ...
                            <p className="text-gray-500 font-medium max-w-2xl text-lg">
                                {isEn
                                    ? "Producing competent, professional, and noble health workers through the MBKM-based curriculum."
                                    : "Mencetak tenaga kesehatan yang kompeten, profesional, dan berakhlakul karimah melalui kurikulum berbasis MBKM."
                                }
                            </p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {faculty.programs.map((program, idx: number) => (
                            <ProgramCard
                                ...
                                level={program.level || ""}
                                accreditation={program.accreditation || "Baik Sekali"}
