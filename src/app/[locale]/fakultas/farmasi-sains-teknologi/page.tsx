...
export default async function ScienceFacultyPage({ params }: Props) {
    ...
    return (
        <main className="bg-gray-50 pb-20">
            <HeroSection
                ...
                backgroundImage={faculty.heroImage || "/images/hero/hero-science.jpg"}
            />
            ...
            <DeanMessage
                ...
                image={faculty.dean?.image || faculty.deanImage || "/images/pimpinan/dekan2.png"}
            />
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-4">
                        <div className="space-y-2">
                            ...
                            <p className="text-gray-500 font-medium max-w-2xl text-lg">
                                {isEn
                                    ? "Integrating science and technology with Islamic values to produce globally competitive graduates."
                                    : "Mengintegrasikan sains dan teknologi dengan nilai-nilai Islam untuk menghasilkan lulusan yang berdaya saing global."
                                }
                            </p>
                        </div>
